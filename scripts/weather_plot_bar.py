...
def general_weather_analysis_demo(data):
    '''
    Run the analysis for number of accidents nationwide versus different weather conditions
...
def main():
    ...
    general_weather_analysis_demo(data)
